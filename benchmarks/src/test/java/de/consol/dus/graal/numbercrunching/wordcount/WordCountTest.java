...
public abstract class WordCountTest {
  ...
  class SanityTest {
    ...
    public void test_shouldReturnExpectedResult_whenCalledWithSampleSentence() {
      // Given:
      String sampleSentence = "Hello World! Hello Germany. Hello Düsseldorf! Hello JCON from ConSol.";
      ...
      // When:
      HashMap<String, Long> actual = getFreshInstance(sampleSentence).count();
