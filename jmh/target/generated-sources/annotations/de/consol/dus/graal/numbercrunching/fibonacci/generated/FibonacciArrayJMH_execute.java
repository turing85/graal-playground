...
import de.consol.dus.graal.numbercrunching.fibonacci.FibonacciArrayJMH;
...
public final class FibonacciArrayJMH_execute {
    ...
    public Collection<ThroughputResult> execute_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            FibonacciArrayJMH_jmh l_fibonacciarrayjmh0_G = _jmh_tryInit_f_fibonacciarrayjmh0_G(control, threadParams);
            ...
            while(!FibonacciArrayJMH_jmh.setupIterationMutexUpdater.compareAndSet(l_fibonacciarrayjmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            try {
                if (!l_fibonacciarrayjmh0_G.readyIteration) {
                    l_fibonacciarrayjmh0_G.setup();
                    l_fibonacciarrayjmh0_G.readyIteration = true;
                }
            } finally {
                FibonacciArrayJMH_jmh.setupIterationMutexUpdater.set(l_fibonacciarrayjmh0_G, 0);
            }
            while(!FibonacciArrayJMH_jmh.setupIterationMutexUpdater.compareAndSet(l_fibonacciarrayjmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            ...
            while (control.warmupShouldWait) {
                l_fibonacciarrayjmh0_G.execute();
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            execute_thrpt_jmhStub(control, res, l_fibonacciarrayjmh0_G, l_blackhole1_0);
            ...
            while(!FibonacciArrayJMH_jmh.tearIterationMutexUpdater.compareAndSet(l_fibonacciarrayjmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            try {
                if (l_fibonacciarrayjmh0_G.readyIteration) {
                    l_fibonacciarrayjmh0_G.tearDown();
                    l_fibonacciarrayjmh0_G.readyIteration = false;
                }
            } finally {
                FibonacciArrayJMH_jmh.tearIterationMutexUpdater.set(l_fibonacciarrayjmh0_G, 0);
            }
            while(!FibonacciArrayJMH_jmh.tearIterationMutexUpdater.compareAndSet(l_fibonacciarrayjmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
    ...
    public void execute_thrpt_jmhStub(InfraControl control, RawResults result, FibonacciArrayJMH_jmh l_fibonacciarrayjmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> execute_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            execute_avgt_jmhStub(control, res, l_fibonacciarrayjmh0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void execute_avgt_jmhStub(InfraControl control, RawResults result, FibonacciArrayJMH_jmh l_fibonacciarrayjmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> execute_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            execute_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_fibonacciarrayjmh0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_fibonacciarrayjmh0_G.execute();
    ...
    public void execute_sample_jmhStub(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, FibonacciArrayJMH_jmh l_fibonacciarrayjmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<SingleShotResult> execute_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            execute_ss_jmhStub(control, batchSize, res, l_fibonacciarrayjmh0_G, l_blackhole1_0);
            control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
    ...
    public void execute_ss_jmhStub(InfraControl control, int batchSize, RawResults result, FibonacciArrayJMH_jmh l_fibonacciarrayjmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile FibonacciArrayJMH_jmh f_fibonacciarrayjmh0_G;
    
    FibonacciArrayJMH_jmh _jmh_tryInit_f_fibonacciarrayjmh0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_fibonacciarrayjmh0_G == null) {
                f_fibonacciarrayjmh0_G = new FibonacciArrayJMH_jmh();
            }
            if (!f_fibonacciarrayjmh0_G.readyTrial) {
                Field f;
                f = FibonacciArrayJMH.class.getDeclaredField("n");
                f.setAccessible(true);
                f.set(f_fibonacciarrayjmh0_G, Integer.valueOf(control.getParam("n")));
                f_fibonacciarrayjmh0_G.readyTrial = true;
            }
        }
        return f_fibonacciarrayjmh0_G;
    }
