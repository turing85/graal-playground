...
import de.consol.dus.graal.numbercrunching.fibonacci.FibonacciRecursiveJMH;
...
public final class FibonacciRecursiveJMH_execute {
    ...
    public Collection<ThroughputResult> execute_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            FibonacciRecursiveJMH_jmh l_fibonaccirecursivejmh0_G = _jmh_tryInit_f_fibonaccirecursivejmh0_G(control, threadParams);
            ...
            while(!FibonacciRecursiveJMH_jmh.setupIterationMutexUpdater.compareAndSet(l_fibonaccirecursivejmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            try {
                if (!l_fibonaccirecursivejmh0_G.readyIteration) {
                    l_fibonaccirecursivejmh0_G.setup();
                    l_fibonaccirecursivejmh0_G.readyIteration = true;
                }
            } finally {
                FibonacciRecursiveJMH_jmh.setupIterationMutexUpdater.set(l_fibonaccirecursivejmh0_G, 0);
            }
            while(!FibonacciRecursiveJMH_jmh.setupIterationMutexUpdater.compareAndSet(l_fibonaccirecursivejmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            ...
            while (control.warmupShouldWait) {
                l_fibonaccirecursivejmh0_G.execute();
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            execute_thrpt_jmhStub(control, res, l_fibonaccirecursivejmh0_G, l_blackhole1_0);
            ...
            while(!FibonacciRecursiveJMH_jmh.tearIterationMutexUpdater.compareAndSet(l_fibonaccirecursivejmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            try {
                if (l_fibonaccirecursivejmh0_G.readyIteration) {
                    l_fibonaccirecursivejmh0_G.tearDown();
                    l_fibonaccirecursivejmh0_G.readyIteration = false;
                }
            } finally {
                FibonacciRecursiveJMH_jmh.tearIterationMutexUpdater.set(l_fibonaccirecursivejmh0_G, 0);
            }
            while(!FibonacciRecursiveJMH_jmh.tearIterationMutexUpdater.compareAndSet(l_fibonaccirecursivejmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            ...
            if (control.isLastIteration()) {
                synchronized(this.getClass()) {
                    f_fibonaccirecursivejmh0_G = null;
                }
                f_blackhole1_0 = null;
            }
    ...
    public void execute_thrpt_jmhStub(InfraControl control, RawResults result, FibonacciRecursiveJMH_jmh l_fibonaccirecursivejmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> execute_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            execute_avgt_jmhStub(control, res, l_fibonaccirecursivejmh0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void execute_avgt_jmhStub(InfraControl control, RawResults result, FibonacciRecursiveJMH_jmh l_fibonaccirecursivejmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> execute_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            execute_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_fibonaccirecursivejmh0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_fibonaccirecursivejmh0_G.execute();
    ...
    public void execute_sample_jmhStub(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, FibonacciRecursiveJMH_jmh l_fibonaccirecursivejmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<SingleShotResult> execute_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            execute_ss_jmhStub(control, batchSize, res, l_fibonaccirecursivejmh0_G, l_blackhole1_0);
            control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
    ...
    public void execute_ss_jmhStub(InfraControl control, int batchSize, RawResults result, FibonacciRecursiveJMH_jmh l_fibonaccirecursivejmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile FibonacciRecursiveJMH_jmh f_fibonaccirecursivejmh0_G;
    
    FibonacciRecursiveJMH_jmh _jmh_tryInit_f_fibonaccirecursivejmh0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_fibonaccirecursivejmh0_G == null) {
                f_fibonaccirecursivejmh0_G = new FibonacciRecursiveJMH_jmh();
            }
            if (!f_fibonaccirecursivejmh0_G.readyTrial) {
                Field f;
                f = FibonacciRecursiveJMH.class.getDeclaredField("n");
                f.setAccessible(true);
                f.set(f_fibonaccirecursivejmh0_G, Integer.valueOf(control.getParam("n")));
                f_fibonaccirecursivejmh0_G.readyTrial = true;
            }
        }
        return f_fibonaccirecursivejmh0_G;
    }
