...
import de.consol.dus.graal.numbercrunching.fibonacci.FibonacciIterativeJMH;
...
public final class FibonacciIterativeJMH_execute {
    ...
    public Collection<ThroughputResult> execute_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            FibonacciIterativeJMH_jmh l_fibonacciiterativejmh0_G = _jmh_tryInit_f_fibonacciiterativejmh0_G(control, threadParams);
            ...
            while(!FibonacciIterativeJMH_jmh.setupIterationMutexUpdater.compareAndSet(l_fibonacciiterativejmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            try {
                if (!l_fibonacciiterativejmh0_G.readyIteration) {
                    l_fibonacciiterativejmh0_G.setup();
                    l_fibonacciiterativejmh0_G.readyIteration = true;
                }
            } finally {
                FibonacciIterativeJMH_jmh.setupIterationMutexUpdater.set(l_fibonacciiterativejmh0_G, 0);
            }
            while(!FibonacciIterativeJMH_jmh.setupIterationMutexUpdater.compareAndSet(l_fibonacciiterativejmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            ...
            while (control.warmupShouldWait) {
                l_fibonacciiterativejmh0_G.execute();
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            execute_thrpt_jmhStub(control, res, l_fibonacciiterativejmh0_G, l_blackhole1_0);
            ...
            while(!FibonacciIterativeJMH_jmh.tearIterationMutexUpdater.compareAndSet(l_fibonacciiterativejmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            try {
                if (l_fibonacciiterativejmh0_G.readyIteration) {
                    l_fibonacciiterativejmh0_G.tearDown();
                    l_fibonacciiterativejmh0_G.readyIteration = false;
                }
            } finally {
                FibonacciIterativeJMH_jmh.tearIterationMutexUpdater.set(l_fibonacciiterativejmh0_G, 0);
            }
            while(!FibonacciIterativeJMH_jmh.tearIterationMutexUpdater.compareAndSet(l_fibonacciiterativejmh0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            ...
            if (control.isLastIteration()) {
                synchronized(this.getClass()) {
                    f_fibonacciiterativejmh0_G = null;
                }
                f_blackhole1_0 = null;
            }
    ...
    public void execute_thrpt_jmhStub(InfraControl control, RawResults result, FibonacciIterativeJMH_jmh l_fibonacciiterativejmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> execute_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            execute_avgt_jmhStub(control, res, l_fibonacciiterativejmh0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void execute_avgt_jmhStub(InfraControl control, RawResults result, FibonacciIterativeJMH_jmh l_fibonacciiterativejmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> execute_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            execute_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_fibonacciiterativejmh0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_fibonacciiterativejmh0_G.execute();
    ...
    public void execute_sample_jmhStub(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, FibonacciIterativeJMH_jmh l_fibonacciiterativejmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<SingleShotResult> execute_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            execute_ss_jmhStub(control, batchSize, res, l_fibonacciiterativejmh0_G, l_blackhole1_0);
            control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
    ...
    public void execute_ss_jmhStub(InfraControl control, int batchSize, RawResults result, FibonacciIterativeJMH_jmh l_fibonacciiterativejmh0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile FibonacciIterativeJMH_jmh f_fibonacciiterativejmh0_G;
    
    FibonacciIterativeJMH_jmh _jmh_tryInit_f_fibonacciiterativejmh0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_fibonacciiterativejmh0_G == null) {
                f_fibonacciiterativejmh0_G = new FibonacciIterativeJMH_jmh();
            }
            if (!f_fibonacciiterativejmh0_G.readyTrial) {
                Field f;
                f = FibonacciIterativeJMH.class.getDeclaredField("n");
                f.setAccessible(true);
                f.set(f_fibonacciiterativejmh0_G, Integer.valueOf(control.getParam("n")));
                f_fibonacciiterativejmh0_G.readyTrial = true;
            }
        }
        return f_fibonacciiterativejmh0_G;
    }
